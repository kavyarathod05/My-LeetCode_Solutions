<h2><a href="https://leetcode.com/problems/maximum-profit-from-trading-stocks-with-discounts/solutions/6781234/3562-maximum-profit-from-trading-stocks-with-discounts/?slug=resulting-string-after-adjacent-removals&region=global_v2">3854. Maximum Profit from Trading Stocks with Discounts</a></h2><h3>Hard</h3><hr><p>You are given an integer <code>n</code>, representing the number of employees in a company. Each employee is assigned a unique ID from 1 to <code>n</code>, and employee 1 is the CEO. You are given two <strong>1-based </strong>integer arrays, <code>present</code> and <code>future</code>, each of length <code>n</code>, where:</p>
